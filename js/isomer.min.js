...
!function(t){function e(t){this.paths="[object Array]"===Object.prototype.toString.call(t)?t:Array.prototype.slice.call(arguments)}e.prototype.push=function(t){this.paths.push(t)},e.prototype.translate=function(){var t=arguments;return new e(this.paths.map(function(e){return e.translate.apply(e,t)}))},e.prototype.rotateZ=function(){var t=arguments;return new e(this.paths.map(function(e){return e.rotateZ.apply(e,t)}))},e.prototype.scale=function(){var t=arguments;return new e(this.paths.map(function(e){return e.scale.apply(e,t)}))},e.prototype.orderedPaths=function(){var t=this.paths.slice();return t.sort(function(t,e){return e.depth()-t.depth()})},e.extrude=function(t,n){n=n||1;var r,a=t.translate(0,0,n),s=new e;for(s.push(t.reverse()),s.push(a),r=0;r<t.points.length;r++)s.push(new Path([a.points[r],t.points[r],t.points[(r+1)%t.points.length],a.points[(r+1)%a.points.length]]));return s},e.Prism=function(t,n,r,a){n=n||1,r=r||1,a=a||1;var s=Isomer.Path,o=Isomer.Point,p=new e,u=new s([t,new o(t.x+n,t.y,t.z),new o(t.x+n,t.y,t.z+a),new o(t.x,t.y,t.z+a)]);p.push(u),p.push(u.reverse().translate(0,r,0));var h=new s([t,new o(t.x,t.y,t.z+a),new o(t.x,t.y+r,t.z+a),new o(t.x,t.y+r,t.z)]);p.push(h),p.push(h.reverse().translate(n,0,0));var i=new s([t,new o(t.x+n,t.y,t.z),new o(t.x+n,t.y+r,t.z),new o(t.x,t.y+r,t.z)]);return p.push(i.reverse()),p.push(i.translate(0,0,a)),p},e.Pyramid=function(t,n,r,a){n=n||1,r=r||1,a=a||1;var s=Isomer.Path,o=Isomer.Point,p=new e,u=new s([t,new o(t.x+n,t.y,t.z),new o(t.x+n/2,t.y+r/2,t.z+a)]);p.push(u),p.push(u.rotateZ(t.translate(n/2,r/2),Math.PI));var h=new s([t,new o(t.x+n/2,t.y+r/2,t.z+a),new o(t.x,t.y+r,t.z)]);return p.push(h),p.push(h.rotateZ(t.translate(n/2,r/2),Math.PI)),p},e.Cylinder=function(t,n,r,a){n=n||1;var s=Isomer.Path,o=s.Circle(t,n,r),p=e.extrude(o,a);return p},e.Plane=function(t,n,r){n=n||1,r=r||1;var a=Isomer.Path,s=new e,o=new a([t,new Point(t.x+n,t.y,t.z),new Point(t.x+n,t.y+r,t.z),new Point(t.x,t.y+r,t.z)]);return s.push(o),s},t.Shape=e}(Isomer);
